...
# Reference taken from: https://github.com/krustnic/xml2kitti
# Added a small tweak: Included source and dest path
...
def process_file(path, destpath):
    xml_reader = XMLReader(path, destpath)
...
def main():
    ...
    for path in args:
        ...
        for file in files:
            if process_file(file, args[1]): processed_file_count += 1
